...
type TaobaoTbkDgOptimusMaterialMapData struct {
	...
	/*
	   定向计划集合     */
	SpCampaignList *[]TaobaoTbkDgOptimusMaterialSpCampaign `json:"sp_campaign_list,omitempty" `
}
...
func (s *TaobaoTbkDgOptimusMaterialMapData) SetUserType(v int64) *TaobaoTbkDgOptimusMaterialMapData {
	s.UserType = &v
	return s
}
...
func (s *TaobaoTbkDgOptimusMaterialMapData) SetSpCampaignList(v []TaobaoTbkDgOptimusMaterialSpCampaign) *TaobaoTbkDgOptimusMaterialMapData {
	s.SpCampaignList = &v
	return s
}
